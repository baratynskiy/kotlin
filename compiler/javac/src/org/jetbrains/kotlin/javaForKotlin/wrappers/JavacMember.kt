...
abstract class JavacMember<out T : Element>(element: T) : JavacElement<T>(element), JavaMember {
    override val containingClass: JavaClass
        get() = JavacClass((element.enclosingElement as TypeElement))
...
val ExecutableElement.valueParameters
        get() = let {
            ...
            parameters.mapIndexed { index, it ->
                ...
                JavacValueParameter(it, parameterName, if (isLastParameter) isVarArgs else false)
            }
        }