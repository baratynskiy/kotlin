...
open class JavacType<out T : TypeMirror>(val typeMirror: T) : JavaType, JavaAnnotationOwner {

    companion object {
        fun <TM : TypeMirror> create(t: TM) = when {
            t.kind.isPrimitive || t.toString() == "void" -> JavacPrimitiveType(t)
